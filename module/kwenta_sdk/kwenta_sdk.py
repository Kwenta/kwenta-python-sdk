...
class kwenta:
    ...
    def modify_position(self, token_symbol: str, position_amount: float,slippage:float=2.0,execute_now:bool=False) -> str:
        """
        Transfers SUSD from wallet to Margin account
        ...
    ...
    # Close full position
    def close_position(self, token_symbol: str,slippage:float=2.0,execute_now:bool=False) -> str:
        """
