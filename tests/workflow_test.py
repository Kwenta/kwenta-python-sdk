...
########################
### INTERNAL NONCE TRACKING TESTING
#######################
account = Kwenta(
    provider_rpc=provider_rpc, wallet_address=wallet_address, private_key=private_key, internal_nonce=True, fast_marketload=True
)
account.get_sm_accounts()
# account.new_sm_account(execute_now=True)
print("Testing Asset Price")
